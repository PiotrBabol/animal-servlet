...
public class ConnectingToSqlite {
    ...
    public /*static*/ Animal findOne(String id1) throws NamingException {
    ...
    public /*static */ List<Animal> findAll() throws NamingException {
    ...
    public static /*static*/ void add(Animal animal) throws NamingException {
        Context ctx = new InitialContext();
        DataSource ds = (DataSource) ctx.lookup("java:comp/env/jdbc/sqlite");
        try (Connection connection = ds.getConnection()) {
    ...
    public /*static */void remove(String idToRemove) throws NamingException {
        Context ctx = new InitialContext();
        DataSource ds = (DataSource) ctx.lookup("java:comp/env/jdbc/sqlite");
        try (Connection connection = ds.getConnection()) {
