...
public class AnimalService {
    ...
    static {
        //mamals
        animalList.add(new Animal("koala", AnimalKingdom.MAMMALS, "The koala (Phascolarctos cinereus, or, inaccurately, koala bear) is an arboreal herbivorous marsupial native to Australia. It is the only extant representative of the family Phascolarctidae and its closest living relatives are the wombats."));
        ...
        //amphibians
        animalList.add(new Animal("frog", AnimalKingdom.AMPHIBIANS, "A frog is any member of a diverse and largely carnivorous group of short-bodied, tailless amphibians composing the order Anura . The oldest fossil \"proto-frog\" appeared in the early Triassic of Madagascar, but molecular clock dating suggests their origins may extend further back to the Permian, 265 million years ago. Frogs are widely distributed, ranging from the tropics to subarctic regions, but the greatest concentration of species diversity is in tropical rainforests."));
        ...
        animalList.add(new Animal("tuna", AnimalKingdom.FISH, "A tuna is a saltwater fish that belongs to the tribe Thunnini, a sub-grouping of the mackerel family (Scombridae)."));
        //birds
        ...
        //reptiles
        animalList.add(new Animal("snake", AnimalKingdom.REPTILES, "Snakes are elongated, legless, carnivorous reptiles of the suborder Serpentes."));
        animalList.add(new Animal("crocodile", AnimalKingdom.REPTILES, "Crocodiles (subfamily Crocodylinae) or true crocodiles are large aquatic reptiles that live throughout the tropics in Africa, Asia, the Americas and Australia. "));
        //invertebrates
